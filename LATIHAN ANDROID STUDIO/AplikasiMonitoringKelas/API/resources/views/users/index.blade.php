...
<div class="glass-card">
    <div class="card-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem;">
        ...
        <div class="search-box" style="position: relative;">
            ...
            <input type="text" id="searchInput" placeholder="Search users..." style="padding: 12px 16px 12px 42px; border: 2px solid rgba(236, 72, 153, 0.2); border-radius: 12px; background: rgba(10, 10, 10, 0.6); color: #ffffff; font-size: 14px; transition: all 0.3s ease; backdrop-filter: blur(10px); min-width: 300px;">
        </div>
    </div>
    <div class="card-body">
        @if($users->count() > 0)
